...
---
Fonte dos dados: Portal de Transparência do DF / Dados Abertos
...
Etapas do Projeto
Data Wrangling: Importação, limpeza e empilhamento dos arquivos anuais (2020-2026).
Análise Exploratória (EDA): Investigação de estatísticas descritivas básicas e comportamento das doações.
Análise Temporal: Mapeamento de picos de doações e sazonalidade ao longo dos meses e anos.
Visualização de Dados: Geração de gráficos de linha, barras e distribuições para responder à pergunta central.
...
Transfere (download) o ficheiro Análise_de_Dados_Doações.ipynb deste repositório.
Abre o Google Colab.
Clica na aba Upload e seleciona o ficheiro .ipynb descarregado.
No painel lateral esquerdo do Colab, faz o upload dos ficheiros .csv de dados (de 2020 a 2026).
Executa as células sequencialmente pressionando Shift + Enter ou clicando no botão de Play.
Opção 2: Pelo VS Code
Clona este repositório no teu computador:
